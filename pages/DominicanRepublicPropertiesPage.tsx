  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const dominicanCities = [...new Set(dominicanProperties.map(p => p.city_label).filter(Boolean))];
        setCities(['all', ...dominicanCities.sort()]);
    ...
    <div className="bg-brand-white">
      <div className="container mx-auto px-6 pt-36 pb-24">
        <header ref={pageHeaderRef} className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-brand-black">Propiedades en Rep. Dominicana</h1>
          <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">Explora el paraíso caribeño y encuentra tu próximo hogar o inversión.</p>
        </header>
...
export default DominicanRepublicPropertiesPage;